...
const passwordLogin = {
  user: {
    ...
    clientID: '21sDKh1BlHy0yxgDRD7J3kTpcmuVIbOJ',
    ...
    user_metadata: {},
    global_client_id: 'dGI66bGsjvhKVixbhDUs9tavPY9oQbYow',
    persistent: {}
  },
  context: {
...
const authorizeLogin = {
  ...
  context: {
    ...
    protocol: 'oidc-basic-profile',
    stats: { loginsCount: 8 },
    sso: { with_auth0: false, with_dbconn: false, current_clients: ['21sDKh1BlHy0yxgDRD7J3kTpcmuVIbOJ'] },
    accessToken: {},
    idToken: {},
    authentication: { methods: [{ name: 'pwd', timestamp: 1558032612724 }] },
